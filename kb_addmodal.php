                            ...
                            <div class="statbox widget box box-shadow" id="modalContent">
                                ...
                                <form method="post" enctype="multipart/form-data" name="choosePasien" id="choosePasien">
                                    <div class="form-group mb-3 mt-3">
                                        ...
                                        <select class="form-control basic" id="pasienSelect" onchange="pageChange('kb_addmodal_content.php')" >
                                    ...
                                    <div class="form-group mb-3 mt-2">
                                        ...
                                        <input type="text" class="form-control" readonly value="Pendaftaran Kohor KB" id="jenis" />
                                    </div>
                                </form>
                                </div> 
