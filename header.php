                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        <a href="#app" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><path xmlns="http://www.w3.org/2000/svg" d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path xmlns="http://www.w3.org/2000/svg" d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
                                <span>Pasien</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                        </a>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#topAccordion">
                            <li>
                                <a href="kehamilan.php"> Kunjungan Ibu Hamil </a>
                            </li>
                            <li>
                                <a href="imunisasi.php"> Imunisasi  </a>
                            </li>
                            <li>
                                <a href="kb.php"> Kohor KB  </a>
                            </li>
                            <li>
                                <a href="neonatus.php"> Neonatus  </a>
                            </li>
                            <li>
                                <a href="persalinan.php"> Persalinan  </a>
                            </li>
                        </ul>
                    </li>
