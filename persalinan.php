                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <?php 
                        ...
                        <div class="widget-content widget-content-area br-6">
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php 
                                            include 'koneksi.php';
                                            $no=1;
                                            $query="select * from persalinan order by no_kunjungan desc";
                                            $data = mysqli_query($koneksi,$query);
                                            while($d = mysqli_fetch_array($data)){
                                                ?>
                                                <tr>
                                                <td><?php echo $d['no_kunjungan'] ?></td>
                                                <td><b><?php echo $d['nama_ibu']; ?></b></td>
                                                <td><?php echo $d['umur']; ?></td>
                                                <td><?php echo $d['nama_suami']; ?></td>
                                                <td><?php echo $d['anak_ke'];  ?></td>
                                                <td><b><?php echo $d['tanggal_lahir']; ?></b></td>
                                                </tr>
                                                <?php 
                                            }
                                        ?>
                                ...
                                <form method="post" enctype="multipart/form-data" name="report" id="report" action="persalinan_print.php" >
