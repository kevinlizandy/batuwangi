...
<!-- <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"> -->
    ...
    <div class="modal-content">
            <div class="modal-header" style="background-color:#7c4dff;color:#fff;">
                            ...
                            <div class="statbox widget box box-shadow" id="modalContent">
                                ...
                                <form method="post" enctype="multipart/form-data" name="choosePasien" id="choosePasien">
                                    <div class="form-group mb-3 mt-3">
                                        ...
                                        <select class="form-control basic" id="pasienSelect" onchange="pageChange('neonatus_addmodal_content.php')" >
                                    ...
                                    <div class="form-group mb-3 mt-2">
                                        ...
                                        <input type="text" class="form-control" readonly value="Pendaftaran Neonatus" id="jenis" />
                                    </div>
                                </form>
                                </div> 
